...
drop policy if exists "Chat participants can view their rooms" on chat_rooms;
drop policy if exists "Users can create chat rooms with influencers" on chat_rooms;
...
drop policy if exists "Users can view their tips" on tips;
drop policy if exists "Users can send tips" on tips;
drop policy if exists "Online status is viewable by everyone" on online_status;
drop policy if exists "Users can update their online status" on online_status;
drop policy if exists "Chat rooms are viewable by participants" on chat_rooms;
